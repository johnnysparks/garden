...
> Last updated 2026-02-24. All engine systems implemented and tested. Diagnosis engine, condition database, tools, and 6 species landed. Amendment bug and energy reset bug fixed; 2 gameplay-balance bugs remain (soil temp init, warm-season growth). CLI complete. Web UI has garden grid with plant/wait actions and a redesigned title screen; remaining work is action flows, diagnosis UI, meta-progression UI, visual overlays, more content, and polish.
...
- **WS5.2 — Scout Action Flow** (todo): Weather peek, pest forecast, soil survey
...
| # | Task | Status |
|---|------|--------|
| 7 | Disease overlay visuals (WS5.4) | todo |
| 8 | Pest visual overlays (WS5.9) | todo |
| 9 | Stress/disease visual modifiers (WS7.7) | todo |
| 10 | Diagnosis UI flow (WS2.2) | todo |
| 11 | Treatment feedback loop (WS2.3) | todo |
| 12 | Scout action UI (WS5.2) | todo |
| 13 | Zoom & detail views (WS5.7) | todo |
